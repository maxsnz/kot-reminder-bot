...
10) В контексте больший вес имеют более поздние сообщения. Они идут после старых.

11) Если пользователь заговорил о каком-то новом напоминании, не связанным с текущим контекстом - ОБЯЗАТЕЛЬНО создай новый контекст. (поле focus: new)
